			...
			<!--script-->
			 ...
			 <div class="top-nav social-icons text-right" style="padding: 10px;" >
				 <ul class="res" style="float:left;margin-top: 1px;">
	 			  <li><a href="http://www.42point1.com/huddle.php">HUDDLE</a></li>
          <li><a href="http://www.42point1.com/meal-a-mile.php">MEAL-A-MILE</a></li>
	 				<li><a href="http://www.42point1.com/gear-up.php" >GEAR-UP</a></li>
          <li><a href="#" >WHAT'S UP?</a></li>
          <li><a href="http://www.42point1.com/about-us.php" >ABOUT US</a></li>
				</ul>
				<ul>
